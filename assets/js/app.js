(function () {
  var CART_KEY = "hightac-yamaha-jogi-cart-v1";
  var SUBMISSION_KEY = "hightac-yamaha-jogi-last-submission-v1";
  var LANG_KEY = "hightac-yamaha-jogi-language-v1";
  var DEFAULT_LANG = "fr";
  ...
  var LOCALES = {
    fr: {
      ...
      title_parts: "Pièces YAMAHA-JOGI",
      ...
      price_notice: "Les prix sont fournis à titre indicatif ; le devis réel fait foi.",
      qty_label: "Qté",
      cart_label: "Panier",
      cart_title: "Panier",
    ...
    en: {
      ...
      latest_price_label: "Prices",
      price_unavailable: "Prices unavailable",
      price_notice: "Prices are for reference only; actual quotation applies.",
      qty_label: "Qty",
      cart_label: "Cart",
      cart_title: "Cart",
    ...
    ar: {
      ...
      latest_price_label: "Prices",
      price_unavailable: "Prices unavailable",
      price_notice: "الأسعار للاسترشاد فقط؛ ويُعتمد عرض السعر الفعلي.",
      qty_label: "الكمية",
      cart_label: "السلة",
      cart_title: "السلة",
  ...
  function getCatalog() {
    ...
    return {
      model: {
        name: "YAMAHA-JOGI",
        motorPicture: "Database/MotorPictures/YAMAHA-JOGI.png"
      },
      parts: []
    };
  }
  ...
  function buildWhatsAppMessage(items, modelName) {
    ...
    return [
      ...
      "",
      "Model: " + modelName,
      "Price note: prices are for reference only; actual quotation applies.",
      "",
      lines.join("\n"),
      "",
  ...
  function submitCart() {
    ...
    var modelName = state.catalog.model.name || "YAMAHA-JOGI";
